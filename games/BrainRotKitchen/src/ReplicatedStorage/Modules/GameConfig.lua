...
-- === IDENTITÉ DU JEU ===
GameConfig.NomDuJeu          = "Brain Rot Kitchen"
GameConfig.Theme             = "kitchen"
GameConfig.CollectibleName   = "Ingredient"
...
-- === COULEURS THÈME ===
GameConfig.CouleurPrimaire   = Color3.fromRGB(255, 100, 100)
