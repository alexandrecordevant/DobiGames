...
local function appliquerEffet(player, playerData, niveauConfig)
    ...
    -- (Arroseur / Sprinkler retiré — Kong)
...
--   require(game.ServerScriptService.ShopSystem).TEST_ForceUpgrade(game.Players:GetPlayers()[1], "Carry")
-- ============================================================
...
local function traiterAchatCoins(player, nomUpgrade, niveauDemande)
    ...
    -- 4.5 Vérifier conditions prérequises (ex: Magnet requiert Carry Lv.2)
