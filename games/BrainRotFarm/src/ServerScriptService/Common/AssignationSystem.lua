...
-- Calcule le CFrame de spawn d'une base (SpawnZone ou fallback centre)
local function trouverCFrameSpawn(baseIndex)
    ...
    -- Priorité 2 : SpawnLocation nommé
