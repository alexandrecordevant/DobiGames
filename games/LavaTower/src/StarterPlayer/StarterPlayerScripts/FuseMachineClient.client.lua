...
mettreAJourRecette = function()
    ...
    for _, sortie in ipairs(recetteTrouvee.outputs) do
        ...
        local icone = ICONE_RARETE[sortie.rarete] or "?"
        parties[#parties + 1] = "<font color='" .. hex .. "'>"
            .. icone .. "  " .. sortie.rarete .. "  <b>" .. sortie.chance .. "%</b></font>"
    end
    if labelResultat then
    ...
    if labelCout then
        labelCout.Text = "<font color='#ffd050'>💰  Coût : " .. recetteTrouvee.cout
